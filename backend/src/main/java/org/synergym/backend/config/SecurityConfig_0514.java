package org.synergym.backend.config;//package org.synergym.backend.config;
//
...
//                        .requestMatchers("/api/auth/login", "/api/auth/register").permitAll()  // 로그인/회원가입은 인증 없이 접근 가능
